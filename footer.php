		...
		<div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
			...
			>
				...
				<div class="mt-8 flex justify-center space-x-6">
					<a href="https://estudiosvedicosclevevd.org/" class="text-red-700 hover:text-red-900">
					...
					<a href="https://www.facebook.com/clev.evd" class="text-red-700 hover:text-red-900">
					...
					<a href="https://www.instagram.com/clev.evd" class="text-red-700 hover:text-red-900">
					...
					<a href="https://www.youtube.com/channel/UCILddSIgcyNq9GYIZWMpx_Q" class="text-red-700 hover:text-red-900">
						<span class="sr-only">Youtube</span>
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-6 w-6" viewBox="0 0 26 26" aria-hidden="true">
